...
<div class="container">
	<div class="row">
		<div class="col-md-8 mb-4">
			...
			if(!empty($bgImage)){
	 			echo $this->Html->image('banner/'.$bgImage,array('alt' => 'Cs-Static','class' => 'img-fluid rounded mb-4')); 
			}
			else {
	 			echo $this->Html->image('cover_pic.jpg',array('alt' => 'Cs-Static','class' => 'img-fluid rounded mb-4')); 
			}	?>
			<div class="row">
				<div class="col-md-12">
