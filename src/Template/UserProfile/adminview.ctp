...
<div class="container content">
    ...
    <?= $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-pencil-square-o')).'Edit', array('action' => 'adminedit', $userProfile->id), array('class' => 'btn btn-primary pull-right','escape' => false)) ?>
            </div>
