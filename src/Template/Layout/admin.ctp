        ...
        <div class="menu">
          <ul class="list">
            ...
            <li>
              ...
              <ul class="ml-menu">
                <li>
                  <?php echo $this->Html->link($this->Html->tag('span', 'My Events'), ['controller' => 'events', 'action' => 'organizerevents'], array('escape'=>false)); ?>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              <?php echo $this->Html->link( $this->Html->tag('i', 'layers', array('class' => 'material-icons')).$this->Html->tag('span', 'My Settlements'), ['controller' => '','action' => ''], array('escape'=>false)); ?>
            </li>
            <li>
        ...
        <div class="menu">
          <ul class="list">
            ...
            <li>
              ...
              <ul class="ml-menu">
                <li>
                  <?php echo $this->Html->link($this->Html->tag('span', 'My Events'), ['controller' => 'events', 'action' => 'myevents'], array('escape'=>false)); ?>
                </li>
              </ul>
            </li>
            <li>
              <?php echo $this->Html->link( $this->Html->tag('i', 'layers', array('class' => 'material-icons')).$this->Html->tag('span', 'My Ticket Details'), ['controller' => '','action' => ''], array('escape'=>false)); ?>
            </li>
            <li>
              <?php echo $this->Html->link( $this->Html->tag('i', 'layers', array('class' => 'material-icons')).$this->Html->tag('span', 'My Settlements'), ['controller' => '','action' => ''], array('escape'=>false)); ?>
            </li>
