...
class ProfileFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'Mobile' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'Zipcode' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'Created' => '2016-09-29 05:43:00',
            'Modified' => '2016-09-29 05:43:00'
        ],
    ];
}
